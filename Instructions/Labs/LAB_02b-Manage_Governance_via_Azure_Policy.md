...
1. 在资源组边栏选项卡上，单击 **“+ 添加”**，然后单击 **“市场”**。

1. 在 **“新建”** 边栏选项卡中，搜索并选择 **“存储帐户”**，然后单击 **“创建”**。 

1. 在 **“创建存储帐户”** 边栏选项卡的 **“基本”** 选项卡上，确认你使用的是应用了策略的资源组并指定以下设置（其他设置保留默认值），单击 **“查看 + 创建”**，然后单击 **“创建”**：
...
1. 在 **“资源组”** 边栏选项卡上，单击 **“+ 添加”和“市场”**。

1. 在 **“新建”** 边栏选项卡中，搜索并选择 **“存储帐户”**，然后单击 **“创建”**。 

1. 在 **“创建存储帐户”** 边栏选项卡的 **“基本”** 选项卡上，确认你使用的是应用了策略的资源组并指定以下设置（其他设置保留默认值），并单击 **“查看 + 创建”**：
