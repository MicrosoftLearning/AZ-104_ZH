...
1. 在 **“编辑模板”** 边栏选项卡上显示模板内容的部分，将第 **35** 行（`"vmSize": "Standard_D2s_v3"`) 替换为以下行：
...
1. 在 **“编辑模板”** 边栏选项卡上显示模板内容的部分，将第 **55** 行（`"dataDisks": [ ]`) 替换为以下代码：
...
1. 保存更改，在 **“az10408vmss0”** 边栏选项卡的 **“设置”** 部分，单击 **“实例”**，选中虚拟机规模集实例旁边的复选框，然后单击 **“升级”**，在提示确认时单击 **“是”**。
